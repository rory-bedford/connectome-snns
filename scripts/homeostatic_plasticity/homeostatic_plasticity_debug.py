...
def main(
    ...
    network_structure = np.load(
        "/tungstenfs/scratch/gzenke/bedfrory/dp-simulations/activity-fitting/teacher-activity/inputs/network_structure.npz"
    )
    ...
    spike_dataset = PrecomputedSpikeDataset(
        spike_data_path="/tungstenfs/scratch/gzenke/bedfrory/dp-simulations/activity-fitting/teacher-activity/results/spike_data.zarr",
    ...
    print(
        f"Batch size: {batch_size} × {n_patterns} patterns = {batch_size * n_patterns} effective"
    )
    print(
