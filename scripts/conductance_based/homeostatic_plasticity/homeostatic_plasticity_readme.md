...
python scripts/run_experiment.py parameters/conductance_based/homeostatic-plasticity.toml
```
...
main(
    ...
    params_file=Path("parameters/conductance_based/homeostatic-plasticity.toml"),
...
Key parameters in `parameters/conductance_based/homeostatic-plasticity.toml`:
