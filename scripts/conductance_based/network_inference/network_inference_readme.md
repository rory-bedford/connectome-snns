...
```bash
python scripts/run_experiment.py parameters/conductance_based/conductance-based-Dp.toml
```
...
conductance_based_Dp.main(
    ...
    params_file=Path("parameters/conductance_based/conductance-based-Dp.toml")
)
```

## Configuration

Key parameters in `parameters/conductance_based/conductance-based-Dp.toml`:
