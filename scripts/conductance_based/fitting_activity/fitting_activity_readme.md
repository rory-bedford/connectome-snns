...
python scripts/fitting_activity/plot_trained_network_vs_target.py \
    ...
    parameters/conductance_based/generate-teacher-activity.toml
```
...
python scripts/run_experiment.py parameters/conductance_based/fitting-activity.toml
```
...
main(
    ...
    params_file=Path("parameters/conductance_based/fitting-activity.toml"),
...
Key parameters in `parameters/conductance_based/fitting-activity.toml`:
