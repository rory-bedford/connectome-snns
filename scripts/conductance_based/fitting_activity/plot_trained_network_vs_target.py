...
from dataloaders.odourants import generate_odour_firing_rates
from network_simulators.conductance_based.simulator import ConductanceLIFNetwork
from configs import SimulationConfig, StudentSimulationConfig
...
def main(experiment_dir, output_dir, teacher_params_file):
    ...
    # Load configuration sections from student parameters
    ...
    # Parse odour configs from teacher parameters
    odours_data = teacher_data["odours"]
    _ = odours_data.pop("tau")  # Remove OU process parameters not used in this script
    _ = odours_data.pop("temperature")
    _ = odours_data.pop("sigma")
    ...
    # Load teacher simulation parameters for dt and chunk_size
    teacher_simulation = SimulationConfig(**teacher_data["simulation"])
    ...
    chunks_to_run = training.get("plot_size", 10)
