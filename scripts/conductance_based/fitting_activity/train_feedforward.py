...
def feedforward_collate_fn(batch: SpikeData) -> SpikeData:
    ...
    Concatenates feedforward and recurrent spikes as inputs, keeps all neurons as targets.
    Designed for training all neurons with feedforward-only dynamics where all recurrent
    ...
    Returns:
        SpikeData named tuple with fields:
            ...
            target_spikes: (batch, time, n_neurons)
    """
