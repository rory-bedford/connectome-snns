...
This script is similar to train_feedforward.py but supports hiding a fraction of
neurons from the network. Hidden neurons are:
...
This simulates scenarios where only a subset of neurons are observable/recorded.
"""
